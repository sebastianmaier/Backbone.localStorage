define([
  ...
  'Backbone'
   ...
   Backbone.sync_orig = Backbone.sync
   
   // Override `Backbone.sync` to use delegate to the model or collection's
   // *localStorage* property, which should be an instance of `Store`.
   Backbone.sync = function(method, model, options, error) {
     
     if (typeof model.localStorage !== 'undefined' || (typeof model.collection !== 'undefined' && typeof model.collection.localStorage !== 'undefined')) {
       ...
       Backbone.sync_orig(method, model, options, error);
     }
   };
